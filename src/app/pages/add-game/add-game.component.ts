...
export class AddGameComponent {
  ...
  form = new FormGroup({
    ...
    price: new FormControl<null | number>(null, [Validators.required, Validators.min(0), Validators.max(100)]),
  ...
  createGame() {
    ...
    const subscription = this.gameFacade.createGame(gamePayload).pipe(
      catchError((err) => {
